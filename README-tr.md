...
**NOT**: Multer, multipart (`multipart/form-data`) olmayan formları işleyemez.
...
`fieldname` adıyla tek bir dosya kabul edin. The single file will be stored
in `req.file`.
...
**Not:** You are responsible for creating the directory when providing
...
**Not:** Multer will not append any file extension for you, your function
should return a filename complete with an file extension.

Each function gets passed both the request (`req`) and some information about
the file (`file`) to aid with the decision.

Not that `req.body` might not have been fully populated yet. It depends on the
...
Aşağıdaki isteğe bağlı özelliklerin boyut sınırlarını belirten bir nesne. Multer passes this object into busboy directly, and the details of the properties can be found on [busboy's page](https://github.com/mscdex/busboy#busboy-methods).
